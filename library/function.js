/*
  ...
  ⚠️ !- Credits By DapzSYZ
  https://wa.me/6285772182461
  
  Note :
   • Dilarang Rename Kalo Ga Pengen Eror
   • Dilarang Sebar Script Nya atau ga gw kick no reff
   • Hargai Yang Buat Lah Cok kalo mau pengen nama sendiri ya beli base nya jangan ngerename mulu
   • Sebar Script? yapit dan rezeki lu terhambat
   
   TQ TO :
   • DapzSYZ : Pembuat Script Nya & Fitur nya
   • All Partner : ( Gatau Kerjaan nya gw )
   • All Friend : Kalo lagi butuh pasti ngilang anj emang
...
const reSize = async (image, ukur1 = 100, ukur2 = 100) => {
  return new Promise(async (resolve, reject) => {
    try {
      const result = await sharp(image).resize(ukur1, ukur2).toBuffer();
      resolve(result);
    } catch (e) {
      reject(e);
    }
