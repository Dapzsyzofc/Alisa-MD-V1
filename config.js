...
//——————————[ Manage Pairing + public ]——————————//
global.connect = true // True For Pairing // False For Qr
global.publicX = true // True For Public // False For Self

//——————————[ Manage Thumb ]——————————//
global.welcomeBg = 'https://raw.githubusercontent.com/Dapzsyzofc/image-bot/main/welcome.jpg'
global.welcomeBgTop = 'https://raw.githubusercontent.com/Dapzsyzofc/image-bot/main/welcome.jpg'
global.Thumb = "https://raw.githubusercontent.com/Dapzsyzofc/image-bot/main/menu.jpg"
global.imgUrl = "https://files.catbox.moe/0fgpp8.jpg"

//——————————[ Manage Bot ]——————————//
global.packname = "ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ" //Pack Name
global.noOwner = ['6285772182461'] //Own Number
global.ownerName = "DapzSYZ"
global.author = "𝐃𝐀𝐏𝐙𝐒𝐘𝐙" // Author
global.ownerNumber = ["6285772182461@s.whatsapp.net"]
global.reply = "https://raw.githubusercontent.com/Dapzsyzofc/image-bot/main/menubutton.jpg"
global.namaBot = "ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ"
global.versiBot = "1.0.0"
global.loadreact = "🧿"
global.themeemoji = "😹"
global.yt = "youtube.com/@DapzSYZOfficial"
global.ig = "@DapzSYZ_"
global.tt = "@DapzSYZ"
global.idch = ""
global.namach = ""
global.linkch = ""
global.linkgc = ""
global.wm = "DapzSYZ | Alisa Assistent"

//——————————[ Manage Payment ]——————————//

// DANA
global.nodana = '085694087363'//Kosongin Kalau Ga Punya
global.andana = 'Nuriyah'

// GOPAY
global.nogopay = '6285694087363'//Kosongin Kalau Ga Punya
global.angopay = 'Slixs'

// OVO
global.noovo = ''//Kosongin Kalau Ga Punya
global.anovo = 'Nama Ovo'

// SHOPEEPAY
global.noshopee = ''//Kosongin Kalau Ga Punya
global.anshopee = 'Nama ShopeePay'

// QRIS
global.qrisUrl = 'https://img1.pixhost.to/images/11252/676617482_dapzsyz.jpg' //Kosongin Kalau Ga Punya

//——————————[ Manage Prefix ]——————————//
global.prefix = ['','!','.',',','🐤','🗿'] // Prefix // Not Change
global.hituet = 0
...
//——————————[ Manage mess ]——————————//
global.mess = {
  owner: "\`⟮ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ⟯\`\nMaaf Kak Fitur Ini Khusus Owner Tersayang",
  group: "\`⟮ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ⟯\`\nMaaf Kak Fitur Ini Khusus Di Group Message",
  admin: "\`[ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ]\`\nMaaf Kak Fitur Ini Khusus Admin Ganteng",
  botAdmin: "\`[ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ]\`\nBot Harus Jadi Admin Dulu Ya Sayang",
  privat: "\`[ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ]\`\nMaaf Kak Fitur Ini Khusus Di Private Message",
  premium: "\`[ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ]\`\nMaaf Kak Fitur Ini Khusus User Premium Dan Owner Tercintah",
  done: "\`[ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ]\`\nDone Ya Kak",
  wait: "\`[ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ]\`\n Tunggu Sebentar Ya Kak, Ini Lagi Proses",
  error: "\`[ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ]\`\nYah Eror Kak, Lapor Ke DapzSYZ Ganteng",
    query: {
       text: "\`[ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ]\`\nTeksnya mana? Aku kan gabisa baca pikiran kaka ",
       link: "\`[ ᴀʟɪꜱᴀ ᴀꜱꜱɪꜱᴛᴇɴᴛ ]\`\nLinknya dongg.. Aku gabisa tanpa link ",
   },
}
